    ...
    <section className="moviescard">
      <div className="moviescard__container">
        <div className="moviescard__info">
          ...
          <Route path='/movies'>
            <button className={`moviescard__button ${ isLiked ? 'moviescard__like' : 'moviescard__dislike'}`} onClick={handleCardButton}></button>
          </Route>
          <Route path='/saved-movies'>
            <button className='moviescard__button moviescard__delete' onClick={handleCardButton}></button>
          </Route>
        </div>
