    ...
    return (
      <section className="login">
        ...
        <form method="post" action="#" id="register-form" name="login-form" className="login__form" noValidate onSubmit={handleSubmit}>
          ...
          <input id="name" name="name" type="name" className={`login__item ${!isValids.name && "login__item_type_error"}`} minLength="2" maxLength="100" required value={values.name} onChange={handleChange}/>
